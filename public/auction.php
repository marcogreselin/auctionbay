...
<div class="container">
    ...
    <p><h6 id="stars-price">Sold
        by <?php echo "<a href=\"feedback.php?for_user_id={$auctionData['seller']}\">" . $auctionData["firstName"] . " " . $auctionData["lastName"] . "</a>" ?>
        (<?php echo $auctionData["stars"] ?> stars)</h6>
